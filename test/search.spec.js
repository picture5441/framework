...
describe('Search any product.', () => {
    ...
    it('Should show "Jewerly" product.', async function () {
        ...
        expect(await searchPage.getNumberOfResults()).to.be.contain(this.validResult);

    }).timeout(Constants.TEST_TIMEOUT);


    it('Should show "aasldasldlasldla" product.', async function () {
